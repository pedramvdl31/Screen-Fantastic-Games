...
<body data-spy="scroll">
    ...
    <header id="header" class="header">  
        <div class="container">            
            <h1 class="logo pull-left" style="padding-top:0">
                <a class="scrollto" href="#promo">
                    <img src="/assets/images/brand_image/perm/sf.png" width="50px">
                </a>
            </h1><!--//logo-->              
    ...
    <section id="promo" class="promo section offset-header">
        <div class="container text-center">
            ...
            <ul class="meta list-inline">
                ...
                <li><a href="ttps://plus.google.com/u/1/+ScreenFanatics" target="_blank">Google +</a></li>
            </ul><!--//meta-->
        </div><!--//container-->
    ...
    <section id="about" class="about section">
        <div class="container">
            <h2 class="title text-center">What is SF?</h2>
            ...
            <div class="contact-inner">
                ...
                <div class="info text-center">
                    ...
                    <ul class="social-icons list-inline">
                        <li><a href="https://www.youtube.com/channel/UCFOa_i0toeaLUATe5jlwKHg" target="_blank"><i class="fa fa-youtube"></i></a></li>
                        <li><a href="https://www.facebook.com" target="_blank"><i class="fa fa-facebook"></i></a></li>
                        <li class="last"><a href="mailto:screenfanaticschannel@gmail.com"><i class="fa fa-envelope"></i></a></li>              
                    </ul>
                </div><!--//info-->
            </div><!--//contact-inner-->
        </div><!--//container-->
    ...
    <footer class="footer">
        <div class="container text-center">
            ...
            <small class="copyright">Designed by <a target="_blank" href="http://www.webprinciples.com/" title="">WebPrinciples</a></small>
        </div><!--//container-->
    </footer><!--//footer-->
